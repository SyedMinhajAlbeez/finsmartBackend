...
const paginatedList = async (req, res) => {
  try {
    ...
    const limit = parseInt(req.query.items) || 10; // Allow configurable limit
    ...
    const sortValue = parseInt(req.query.sortValue) === 1 ? 1 : -1; // Modified to default to -1
    const allowedSortFields = ['enabled', 'createdAt', 'updatedAt', 'total', 'paymentStatus'];
